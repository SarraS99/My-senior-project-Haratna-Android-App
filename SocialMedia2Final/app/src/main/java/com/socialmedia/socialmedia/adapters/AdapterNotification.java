...
import com.socialmedia.socialmedia.models.ModelNotification;
    ...
    public void onBindViewHolder(@NonNull final HolderNotification holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setMessage("هل أنت متأكد من حذف هذا الاشعار؟");
                        ...
                        ref.child(firebaseAuth.getUid()).child("Notifications").child(timestamp)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        //deleted
                                        Toast.makeText(context, "تم حذف الاشعار...", Toast.LENGTH_SHORT).show();
                                    }
                                })
