...
import com.socialmedia.socialmedia.databinding.ActivityMapLocationPickerBinding;
...
public class MapLocationPickerActivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        binding.toolbarGpsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isGPSEnabled()) {
                    ...
                    Toast.makeText(MapLocationPickerActivity.this, "الموقع ليس قيد التشغيل! قم بتشغيله لإظهار الموقع الحالي ...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void pinPost() {
        ...
        DatabaseReference refSearch = FirebaseDatabase.getInstance().getReference("Posts");
                                ...
                                ref.child(postId)
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                Toast.makeText(MapLocationPickerActivity.this, "تم التثبيت بنجاح ...", Toast.LENGTH_SHORT).show();
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(MapLocationPickerActivity.this, "فشل التثبيت بسبب " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        }, 2000);
            ...
            new ActivityResultCallback<Boolean>() {
                ...
                public void onActivityResult(Boolean isGranted) {
                    ...
                    if (isGranted) {
                        ...
                        Toast.makeText(MapLocationPickerActivity.this, "تم رفض الإذن...", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
