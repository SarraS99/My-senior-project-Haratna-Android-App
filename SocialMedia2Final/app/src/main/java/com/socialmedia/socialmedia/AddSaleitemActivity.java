...
public class AddSaleitemActivity extends AppCompatActivity {
    FirebaseAuth firebaseAuth;
    DatabaseReference userDbRef;

    ActionBar actionBar;

    String [] categArr = {"ديكور المنزل", "أواني طبخ", "أدوات كهربائية", "أدوات مكتبية"};
    ...
    //views
    EditText titleEt, descriptionEt, sPrice;
    Spinner category;
    ImageView imageIv;
    Button uploadBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_saleitem);
        ...
        //init views
        titleEt = findViewById(R.id.sTitleEt);
        descriptionEt = findViewById(R.id.sDescriptionEt);
        sPrice = findViewById(R.id.sPriceEt);
        imageIv = findViewById(R.id.sImageIv);
        uploadBtn = findViewById(R.id.sUploadBtn);
        category = findViewById(R.id.sCategory);

        sPrice.setFilters(new InputFilter[] {
                new DigitsKeyListener(Boolean.FALSE, Boolean.TRUE) {
                    int beforeDecimal = 7, afterDecimal = 2;
                    @Override
                    public CharSequence filter(CharSequence source, int start, int end,
                                               Spanned dest, int dstart, int dend) {
                        String temp = sPrice.getText() + source.toString();
                        if (temp.equals(".")) {
                            return "0.";
                        }
        ...
        ArrayAdapter<String> categoryAdapter = new ArrayAdapter<String>(AddSaleitemActivity.this, android.R.layout.simple_spinner_item, categArr);
        ...
        category.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(AddSaleitemActivity.this, value, Toast.LENGTH_SHORT).show();
            }
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddSaleitemActivity.this, "أضف عنوان...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (imageIv.getDrawable() == null){
                    Toast.makeText(AddSaleitemActivity.this, "أضف صورة...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(AddSaleitemActivity.this, "أضف وصف...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(price)){
                    Toast.makeText(AddSaleitemActivity.this, "أضف سعر...", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddSaleitemActivity.this, "تم التحديث...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AddSaleitemActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void updateWithNowImage(final String title, final String description, final String editPostId) {
        ...
        String filePathAndName = "Saleitems/"+ "salepost_"+timeStamp;
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()){
                            ...
                            hashMap.put("sEmail", email);
                            hashMap.put("sDp", dp);
                            hashMap.put("sTitle", title);
                            hashMap.put("sDescr", description);
                                        ...
                                        if (uriTask.isSuccessful()){
                                            ...
                                            ref.child(editPostId)
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            pd.dismiss();
                                                            Toast.makeText(AddSaleitemActivity.this, "محدث...", Toast.LENGTH_SHORT).show();
                                                        }
                                                    })
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        @Override
    ...
    private void loadPostData(String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Saleitems");
        //get detail of post using id of post
        Query fquery = reference.orderByChild("sId").equalTo(editPostId);
        fquery.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    //get data
                    editTitle = ""+ds.child("sTitle").getValue();
                    editDescription = ""+ds.child("sDesc").getValue();
                    editImage = ""+ds.child("sImage").getValue();
                    editPrice = ""+ds.child("sPrice").getValue();


                    //set data to views
                    titleEt.setText(editTitle);
                    descriptionEt.setText(editDescription);
                    sPrice.setText(editPrice);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                hashMap.put("sTitle", title);
                                hashMap.put("sDesc", description);
                                hashMap.put("sImage", downloadUri);
                                hashMap.put("sTime", timeStamp);
                                hashMap.put("sCategory", strcategory);
                                hashMap.put("sPrice", price);
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddSaleitemActivity.this, "تم نشر المنشور", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //error occurred
                        Toast.makeText(AddSaleitemActivity.this, ""+error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
