...
import com.socialmedia.socialmedia.adapters.AdapterBusComments;
import com.socialmedia.socialmedia.models.ModelComment;
...
public class BusPostDetailActivity extends AppCompatActivity {
    ...
    AdapterBusComments adapterComments;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_post_detail);
        ...
        actionBar.setSubtitle("بحساب: "+myEmail);
        ...
        pLikesTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BusPostDetailActivity.this, BusPostLikedByActivity.class);
    ...
    private void loadComments() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("BusPosts").child(postId).child("BusComments");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    //setup adapter
                    adapterComments = new AdapterBusComments(getApplicationContext(), commentList, myUid, postId);
                    //set adapter
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id==0){
                    ...
                    Intent intent = new Intent(BusPostDetailActivity.this, AddBusPostActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("BusPosts").orderByChild("pId").equalTo(postId);
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                //deleted
                                Toast.makeText(BusPostDetailActivity.this, "حذف بنجاح", Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(BusPostDetailActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void setLikes() {
        ...
        final DatabaseReference likesRef = FirebaseDatabase.getInstance().getReference().child("BusLikes");
    ...
    private void likePost() {
        ...
        final DatabaseReference likesRef = FirebaseDatabase.getInstance().getReference().child("BusLikes");
        final DatabaseReference postsRef = FirebaseDatabase.getInstance().getReference().child("BusPosts");
        likesRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (mProcessLike){
                    if (dataSnapshot.child(postId).hasChild(myUid)){
                        ...
                        addToHisNotifications(""+hisUid, ""+postId, "أحب منشورك");
                    }
                }
            }
        ...
        ref.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //added
                        pd.dismiss();
                        Toast.makeText(BusPostDetailActivity.this, "تم إضافة التعليق...", Toast.LENGTH_SHORT).show();
                        commentEt.setText("");
                        updateCommentCount();

                        addToHisNotifications(""+hisUid,""+postId,"علق على منشورك");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
    ...
    private void updateCommentCount() {
        ...
        final DatabaseReference ref = FirebaseDatabase.getInstance().getReference("BusPosts").child(postId);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    pLikesTv.setText(pLikes + "الإعجابات");
                    pTimeTiv.setText(pTime);
                    pCommentsTv.setText(commentCount +" التعليقات");
                    ...
                    try {
                        Picasso.get().load(hisDp).placeholder(R.drawable.user1_icon).into(uPictureIv);
                    }catch (Exception e){
                        Picasso.get().load(R.drawable.user1_icon).into(uPictureIv);
                    }
