        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddPostActivity.this, "أضف عنوان...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(AddPostActivity.this, "أضف وصف...", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddPostActivity.this, "تم التحديث...", Toast.LENGTH_SHORT).show();
                    }
                })
                                        ...
                                        if (uriTask.isSuccessful()){
                                            ...
                                            ref.child(editPostId)
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            pd.dismiss();
                                                            Toast.makeText(AddPostActivity.this, "محدث...", Toast.LENGTH_SHORT).show();
                                                        }
                                                    })
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        @Override
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddPostActivity.this, "تم نشر المنشور", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
