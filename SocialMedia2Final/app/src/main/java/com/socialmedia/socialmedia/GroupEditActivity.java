...
public class GroupEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("تحرير المجموعة");
    ...
    private void startUpdatingGroup() {
        ...
        if (TextUtils.isEmpty(groupTitle)){
            Toast.makeText(this, "عنوان المجموعة مطلوب ...", Toast.LENGTH_SHORT).show();
            return;
        }

        progressDialog.setMessage("جارٍ تحديث معلومات المجموعة ...");
        progressDialog.show();
            ...
            ref.child(groupId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(GroupEditActivity.this, "تم تحديث معلومات المجموعة ...", Toast.LENGTH_SHORT).show();
                        }
                    })
