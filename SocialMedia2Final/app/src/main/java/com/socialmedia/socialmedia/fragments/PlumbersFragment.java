 ...
 */
public class PlumbersFragment extends Fragment {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    try {
                        ...
                        if (!modelUser.getUid().equals(firebaseAuth.getUid()) && userNeighborhood.equals(myNeighbourhood) && category.equals("1")) {
