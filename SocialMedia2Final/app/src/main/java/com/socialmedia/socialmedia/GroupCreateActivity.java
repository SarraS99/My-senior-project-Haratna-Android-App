...
public class GroupCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("إنشاء مجموعة");
    ...
    private void startCreatingGroup() {
        ...
        progressDialog.setMessage("تكوين المجموعة");
        ...
        if (TextUtils.isEmpty(groupTitle)){
            Toast.makeText(this, "الرجاء إدخال عنوان المجموعة ...", Toast.LENGTH_SHORT).show();
        ...
        ref.child(g_timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        hashMap1.put("role", "creator"); //roles are creator, admin, participant
                        ...
                        ref1.child(g_timestamp).child("Participants").child(firebaseAuth.getUid())
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        //participant added
                                        progressDialog.dismiss();
                                        Toast.makeText(GroupCreateActivity.this, "تم إنشاء المجموعة ...", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
            ...
            case STORAGE_REQUEST_CODE:{
                if (grantResults.length > 0){
                    ...
                    if (storageAccepted){
                        ...
                        //permission denied
                        Toast.makeText(this, "أذونات التخزين المطلوبة", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }
