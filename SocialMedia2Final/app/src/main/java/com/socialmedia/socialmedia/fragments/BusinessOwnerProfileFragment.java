...
import com.socialmedia.socialmedia.PagerAdapter;
 ...
 */
public class BusinessOwnerProfileFragment extends Fragment {
    ...
    String [] category = {"اخرى","مطاعم","اطباء","صالون للشعر","معلمين","قانونين","سباكين","مقاولين","مكانينين"};
    ...
    public BusinessOwnerProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_business_owner_profile, container, false);
    ...
    private void searchMyPosts(final String searchQuery) {
        ...
        layoutManager.setReverseLayout(true);
        //set this layout to recyclerview
        postFragment.postsRecyclerView.setLayoutManager(layoutManager);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    adapterPosts = new AdapterPosts(getActivity(), postList);
                    //set this adapter to recyclerview
                    postFragment.postsRecyclerView.setAdapter(adapterPosts);
                }
            }
    ...
    private void showEditProfileDialog() {
        ...
        String options[] = {"تحرير صورة الملف الشخصي" , "تحرير صورة الغلاف" , "تحرير الاسم" ,"تحرير الوصف", "تغيير رقم الجوال" ,"تغيير الايميل","تغيير التصنيف", "تغيير كلمة المرور"};
        //alert dialog
        ...
        updatePasswordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(oldPassword)){
                    Toast.makeText(getActivity(), "أدخل كلمة المرور الحالية", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (newPassword.length()<8){
                    Toast.makeText(getActivity(), "يجب ألا يقل طول كلمة المرور عن 8 أحرف", Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        user.updatePassword(newPassword)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        //password updated
                                        pd.dismiss();
                                        Toast.makeText(getActivity(), "تم تحديث كلمة السر", Toast.LENGTH_SHORT).show();
                                    }
                                })
    ...
    private void showNamePhoneUpdateDialog(final String key) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        if(key == "name"){
            builder.setTitle("تحديث الاسم");
        }
        if(key == "phone") {
            builder.setTitle("تحديث رقم الجوال");
        }
        if(key == "bio"){
            builder.setTitle("تحديث الوصف");
        }if(key == "email"){
            builder.setTitle("تحديث الايميل");
        }
        //builder.setTitle("تحديث" + key); //e.g. Update name OR Update phone
        ...
        if(key == "name"){
            editText.setHint("ادخل الاسم");
        }
        if(key == "phone") {
            editText.setHint("ادخل رقم الجوال");
        }
        if(key == "bio") {
            editText.setHint("ادخل الوصف");
        }if(key == "email") {
            editText.setHint("ادخل الايميل");
        }
        //editText.setHint("ادخل " + key); //hint e.g. Edit name OR Edit phone
        ...
        builder.setPositiveButton("تحديث", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    databaseReference.child(user.getUid()).updateChildren(result)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    pd.dismiss();
                                    Toast.makeText(getActivity(), "محدث", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                    ...
                    if(key == "name"){
                        Toast.makeText(getActivity(), "الرجاء ادخال الاسم", Toast.LENGTH_SHORT).show();
                    }
                    if(key == "phone") {
                        Toast.makeText(getActivity(), "الرجاء ادخال رقم الجوال" , Toast.LENGTH_SHORT).show();
                    }
                    if(key == "bio") {
                        Toast.makeText(getActivity(), "الرجاء ادخال الوصف" , Toast.LENGTH_SHORT).show();
                    }if(key == "email") {
                        Toast.makeText(getActivity(), "الرجاء ادخال الايميل" , Toast.LENGTH_SHORT).show();
                    }
                    // Toast.makeText(getActivity(), "الرجاء ادخال " + key, Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void categoryUpdateDialog(final String key) {
        //custom dialog
        AlertDialog.Builder builder2 = new AlertDialog.Builder(getActivity());
        builder2.setTitle("تحديث التصنيف");
            ...
            builder2.setPositiveButton("تحديث", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    //input text from edit text
                    //final String value = editText.getText().toString().trim();
                    String value = mSpinner.getSelectedItem().toString();
                    if (value.equals("مكانينين")) {
                        Toast.makeText(getActivity(), "مكانينين", Toast.LENGTH_SHORT).show();
                    ...
                    } else if (value.equals("مقاولين")) {
                        Toast.makeText(getActivity(), "مقاولين", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("سباكين")) {
                        Toast.makeText(getActivity(), "سباكين", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("قانونين")) {
                        Toast.makeText(getActivity(), "قانونين", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("معلمين")) {
                        Toast.makeText(getActivity(), "معلمين", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("صالون للشعر")) {
                        Toast.makeText(getActivity(), "صالون للشعر", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("اطباء")) {
                        Toast.makeText(getActivity(), "اطباء", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("مطاعم")) {
                        Toast.makeText(getActivity(), "مطاعم", Toast.LENGTH_SHORT).show();
                        ...
                        dialogInterface.dismiss();
                    } else if (value.equals("اخرى")) {
                        Toast.makeText(getActivity(), "اخرى", Toast.LENGTH_SHORT).show();
            ...
            case CAMERA_REQUEST_CODE: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted && writeStorageAccepted) {
                        ...
                        //pemissions denied
                        Toast.makeText(getActivity(), "يرجى تمكين إذن الكاميرا والتخزين", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
            case STORAGE_REQUEST_CODE: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (writeStorageAccepted) {
                        ...
                        //pemissions denied
                        Toast.makeText(getActivity(), "الرجاء تمكين إذن التخزين", Toast.LENGTH_SHORT).show();
                    }
                }
                            ...
                            databaseReference.child(user.getUid()).updateChildren(results)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            pd.dismiss();
                                            Toast.makeText(getActivity(), "تم تحديث الصورة", Toast.LENGTH_SHORT).show();
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            //dismiss progress bar
                                            pd.dismiss();
                                            Toast.makeText(getActivity(), "خطأ في تحديث الصورة", Toast.LENGTH_SHORT).show();
                                        }
                                    });
