...
public class BusPostLikedByActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_post_liked_by);

        //actionbar
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("تم الإعجاب بواسطة");
        //add back button
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("BusLikes");
        ...
        ref.orderByChild("uid").equalTo(hisUid)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        //setup adapter
                        adapterUsers = new AdapterUsers(BusPostLikedByActivity.this, userList);
