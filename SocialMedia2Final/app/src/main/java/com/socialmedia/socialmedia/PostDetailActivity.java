...
import com.socialmedia.socialmedia.adapters.AdapterComments;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void showMoreOptions() {
        ...
        if (hisUid.equals(myUid)){
            ...
            popupMenu.getMenu().add(Menu.NONE, 2, 2, "تثبيت المنشور");
        }
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id==0){
                    ...
                    //Edit is clicked
                    //start AddPostActivity with key "editPost" and the id of the post clicked
                    Intent intent = new Intent(PostDetailActivity.this, MapLocationPickerActivity.class);
                    intent.putExtra("postId", postId);
                    startActivity(intent);
                }
                return false;
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                //deleted
                                Toast.makeText(PostDetailActivity.this, "حذف بنجاح", Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
        ...
        ref.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //added
                        pd.dismiss();
                        Toast.makeText(PostDetailActivity.this, "تم إضافة التعليق...", Toast.LENGTH_SHORT).show();
                        commentEt.setText("");
                        updateCommentCount();
