...
public class AddBusPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bus_post);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddBusPostActivity.this, "أضف عنوان...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(AddBusPostActivity.this, "أضف وصف...", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (isUpdateKey.equals("editPost")){
                    ...
                    AddBusPostActivity.this.finish();
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddBusPostActivity.this, "تم التحديث...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AddBusPostActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void updateWithNowImage(final String title, final String description, final String editPostId) {
        ...
        String filePathAndName = "BusPosts/"+ "post_"+timeStamp;
                                        ...
                                        if (uriTask.isSuccessful()){
                                            ...
                                            ref.child(editPostId)
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            pd.dismiss();
                                                            Toast.makeText(AddBusPostActivity.this, "محدث...", Toast.LENGTH_SHORT).show();
                                                        }
                                                    })
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        @Override
    ...
    private void loadPostData(String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("BusPosts");
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddBusPostActivity.this, "تم نشر المنشور", Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //error occurred
                        Toast.makeText(AddBusPostActivity.this, ""+error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
