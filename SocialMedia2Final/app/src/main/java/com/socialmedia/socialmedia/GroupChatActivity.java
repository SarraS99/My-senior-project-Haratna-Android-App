...
import com.socialmedia.socialmedia.adapters.AdapterGroupChat;
import com.socialmedia.socialmedia.models.ModelGroupChat;
...
public class GroupChatActivity extends AppCompatActivity {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)) {
                    //empty, don't send
                    Toast.makeText(GroupChatActivity.this, "لا يمكن إرسال رسالة فارغة ...", Toast.LENGTH_SHORT).show();
                } else {
                    //send message
                    sendMessage(message);
                }
    ...
    private void pickGallery() {
        //intent to pick image fro galllery
    ...
    private void sendImageMessage() {
        ...
        pd.setTitle("الرجاء الإنتظار");
        pd.setMessage("إرسال الصورة ...");
            ...
            case STORAGE_REQUEST_CODE:
                if (grantResults.length > 0) {
                    ...
                    if (writeStorageAccepted) {
                        ...
                        Toast.makeText(this, "مطلوب إذن التخزين ...", Toast.LENGTH_SHORT).show();
