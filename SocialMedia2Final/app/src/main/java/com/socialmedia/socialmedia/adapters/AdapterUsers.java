...
import com.socialmedia.socialmedia.ChatActivity;
...
public class AdapterUsers extends RecyclerView.Adapter<AdapterUsers.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, final int i) {
        ...
        String userCover = userList.get(i).getCover();
        ...
        try {
            Picasso.get().load(userImage)
                    .placeholder(R.drawable.user1_icon)
        ...
        try {
            Picasso.get().load(userCover)
                    .placeholder(R.drawable.user1_icon)
                    .into(myHolder.coverIv);
        }
        catch (Exception e){
        ...
        myHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setItems(new String[]{"الملف الشخصي", "الدردشة"}, new DialogInterface.OnClickListener() {
                    @Override
        ...
        ref.child(hisUID).child("BlockedUsers").orderByChild("uid").equalTo(myUid)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            if (ds.exists()){
                                Toast.makeText(context, "لقد حظرك هذا المستخدم ، ولا يمكنك إرسال رسالة", Toast.LENGTH_SHORT).show();
        ...
        ref.child(myUid).child("BlockedUsers").child(hisUID).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(context, "تم الحظر بنجاح...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed to block
                        Toast.makeText(context, "فشل: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                                ...
                                ds.getRef().removeValue()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(context, "تم إلغاء الحظر بنجاح ...", Toast.LENGTH_SHORT).show();
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        ImageView mAvatarIv, blockIv, coverIv;
