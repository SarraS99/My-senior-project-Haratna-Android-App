...
import com.socialmedia.socialmedia.adapters.AdapterChat;
import com.socialmedia.socialmedia.models.ModelChat;
import com.socialmedia.socialmedia.models.ModelUser;
import com.socialmedia.socialmedia.notifications.Data;
import com.socialmedia.socialmedia.notifications.Sender;
...
public class ChatActivity extends AppCompatActivity {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (typingStatus.equals(myUid)) {
                        ...
                        if (onlineStatus.equals("online")) {
                            ...
                            userStatusTv.setText("شوهد آخر مرة في:" + dateTime);
                    ...
                    try {
                        ...
                        profileIv.setImageResource(R.drawable.ic_default_img_white);
                    }
                }
            }
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)) {
                    //text empty
                    Toast.makeText(ChatActivity.this, "لا يمكن إرسال الرسالة الفارغة ...", Toast.LENGTH_SHORT).show();
                } else {
                    //text not empty
                    sendMessage(message);
                }
        ...
        ref.child(myUid).child("BlockedUsers").child(hisUid).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(ChatActivity.this, "تم الحظر بنجاح ...", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed to block
                        Toast.makeText(ChatActivity.this, "فشل: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                                ...
                                ds.getRef().removeValue()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(ChatActivity.this, "تم إلغاء الحظر بنجاح ...", Toast.LENGTH_SHORT).show();
    ...
    private void showImagePickDialog() {
        ...
        builder.setTitle("اختر الصورة من");
    ...
    private void sendImageMessage(Uri image_rui) throws IOException {
        ...
        progressDialog.setMessage("إرسال الصورة ...");
        progressDialog.show();
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", senderJsonObj,
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "key=AAAAU8CjI8Q:APA91bFeek_cZo-V9JquF1rZGgfEZ3KFGrTqmBS6uoCXg91pbQFl7jEQMIHm-Ue5CVCVDFELRGmkFUNekcAjyyRHhR1HSIdTfhBVrlYGDTXuvASIoeUQuT2TmNbq28eyR_uZC4V3024m");
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length>0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(this, "الكاميرا والتخزين كلا الإذنين ضروريان ...", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                }
